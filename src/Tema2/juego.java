        ...
        /*¿quién empieza*/
            ...
            while (puntosvida_1 > 0 && puntosvida_2 > 0) {
                ...
                if (velocidad_1 >= velocidad_2) {
                    System.out.println("Jugadorr 1, es tu turno.Si desees atacar apreta 1, si deseas defenderte apreta 2, si deseas" +
                    ...
                    switch (jugada_1){
                        case 1 -> {
                            ...
                            } else if (ataque_1<150) {
                                int dano = 10 + random.nextInt(20);
                                System.out.println("Le has hecho " + dano + " puntos de daño");
                                puntosvida_2 = puntosvida_2 - dano;
                            }else{
                                int dano = 20 + random.nextInt(40);
                                System.out.println("Le has hecho " + dano + " puntos de daño");
                                puntosvida_2 = puntosvida_2 - dano;
                            }
                        }
                        case 2 ->{
                            ...
                            } else if (defensa_1<150){
                                int vida = 10 + random.nextInt(20);
                                System.out.println("Te has dado " + vida + " puntos de vida.");
                                puntosvida_1 = puntosvida_1 + vida;
                            } else {
                                int vida = 20 + random.nextInt(40);
                                System.out.println("Te has dado " + vida + " puntos de vida.");
                                puntosvida_1 = puntosvida_1 + vida;
                            }
                        }
                        case 3 ->{
                            if (ataque_1 < 50) {
                                ...
                                int danox2 = 20 + random.nextInt(40);
                                System.out.println("Le has hecho " + danox2 + " puntos de daño");
                                puntosvida_2 = puntosvida_2 - danox2;
                            } else {
                                int danox2 = 40 + random.nextInt(50);
                                System.out.println("Le has hecho " + danox2 + " puntos de daño");
                                puntosvida_2 = puntosvida_2 - danox2;
                            }
                        }
                    ...
                    if (puntosvida_2 > 0) {
                        ...
                        System.out.println("Ronda " + ronda);
                        System.out.println("Jugador 1: " + puntosvida_1 + "---------------------------------");
                        System.out.println("Jugador 2: " + 0 + "---------------------------------");
